...
DROP FUNCTION IF EXISTS public.insert_monitoring_event;
...
BEGIN
  IF NOT EXISTS (
    ...
    AND p.proname = 'insert_monitoring_event'
  ) THEN
    RAISE EXCEPTION 'Function public.insert_monitoring_event does not exist';
  END IF;
END;
$$; 